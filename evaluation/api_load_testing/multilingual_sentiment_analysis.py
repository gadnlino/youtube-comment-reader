...
TEST_VIDEOS = [
    ...
    },
    {
        ...
        'language': 'English',
        'region': 'Global',
        'description': 'Pop music - predominantly English with some multilingual'
    },
    ...
    # === FRENCH VIDEOS ===
    {
        ...
        'language': 'English',
        'region': 'UK/Global',
        'description': 'Indie folk - English comments with some European languages'
    },
    
    # === JAPANESE/ANIME ===
    {
        'id': 'CJiG15euUes',
        'name': 'RADWIMPS - Sparkle (Your Name OST)',
        'language': 'Japanese',
        'region': 'Japan',
        'description': 'Anime soundtrack - primarily Japanese comments'
    }
]
