...
Scripts de benchmark (reorg out 2025): **`evaluation/scripts/02_api_performance/benchmarks/`**

Geradores de gráficos: **`evaluation/scripts/02_api_performance/generators/`**
