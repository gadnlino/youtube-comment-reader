...
def generate_language_comparison_bar_chart(data, timestamp):
    ...
    filename = f'graphs/language_neutral_bias_comparison_{timestamp}.png'
...
def generate_individual_video_chart(data, timestamp):
    ...
    import os
    os.makedirs("graphs", exist_ok=True)
    filename = f'graphs/individual_video_neutral_rates_{timestamp}.png'
    plt.savefig(filename, dpi=300, bbox_inches='tight', facecolor='white')
    print(f"✓ Generated: {filename}")
    plt.close()
...
def generate_sentiment_distribution_heatmap(data, timestamp):
    ...
    import os
    os.makedirs("graphs", exist_ok=True)
    filename = f'graphs/sentiment_distribution_heatmap_{timestamp}.png'
    plt.savefig("graphs/" + filename, dpi=300, bbox_inches='tight', facecolor='white')
    print(f"✓ Generated: {filename}")
    plt.close()
...
def generate_language_bias_statistical_plot(data, timestamp):
    ...
    import os
    os.makedirs("graphs", exist_ok=True)
    filename = f'graphs/language_bias_boxplot_{timestamp}.png'
    plt.savefig(filename, dpi=300, bbox_inches='tight', facecolor='white')
    print(f"✓ Generated: {filename}")
    plt.close()
...
def main():
    ...
    # Load latest results - tenta results/, depois api_load_testing, depois local
    import glob
