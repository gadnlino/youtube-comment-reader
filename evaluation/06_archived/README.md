...
| Pasta / arquivo | Conteúdo | Substituição canônica |
|------------------|----------|----------------------|
| `pruned_figures/2026-06/` | ~160 PNGs removidos (limpeza só ativos do docx) | [`../02_graphs/MANIFEST.md`](../02_graphs/MANIFEST.md) |
...
| `GUIA_INSERCAO_FIGURAS_FINAL.md` | Guia figuras nov 2025 | Não usado no docx atual |
