...
Metodologia detalhada, rascunhos da monografia e documentos de navegação.

## Propósito

Texto longo e orientação para redigir ou reproduzir a avaliação — complementa [`../01_reports/`](../01_reports/README.md).
...
Leitura para redacção; executar scripts via [`../scripts/CATALOG.md`](../scripts/CATALOG.md).

## Ver também

- [`../01_reports/TESTING_METHODOLOGY.md`](../01_reports/TESTING_METHODOLOGY.md)
- [`../README.md`](../README.md)
